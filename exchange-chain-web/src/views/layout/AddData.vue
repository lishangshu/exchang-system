            ...
            <div class="add-wrapper">
                        ...
                        <Row>
                            <Col span="15">
                               <FormItem label="所属区域：" class="add-form-content city-form">
                                    <Cascader @on-change="handleCity" :transfer="transferPosition" v-model="areaArr" :data="areaData" size="large"></Cascader>
                                </FormItem>
                            </Col>
                        </Row>
                        <Row>
                        ...
                        <Row>
                            <Col span="15">
                                <FormItem label="邮编：" class="add-form-content">
                                    <Input type="number" size="large" v-model="formValidate.maillNo" placeholder="请输入邮编"></Input>
                                </FormItem>
                            </Col>
                        </Row>
                        <Row>
                ...
                <div class="add-box">
                    ...
                    <div class="add-box-form">
                        ...
                        <Row>
                            <Col span="15">
                                <FormItem class="add-form-content" label="域名服务器：">
                                    <Input type="text" size="large" v-model="formValidate.wiServerIp" placeholder="请输入域名服务器："></Input>
                                </FormItem>
                            </Col>
                        </Row>
                        <Row>
                        ...
                        <Row>
                            <Col span="15">
                                <FormItem class="add-form-content">
                                    <Button type="primary" size="large" class="login-button data-btn" @click="handleSubmit()">确定</Button>
                                </FormItem>
                            </Col>
                        </Row>
                    </div>
